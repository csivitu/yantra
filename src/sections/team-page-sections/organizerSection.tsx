...
const OrganizersSection = () => {
    ...
    return (
        <>
            <div
                id="organizing-team"
                className="w-full mt-16 max-md:text-4xl max-md:mt-0 h-[20vh] flex justify-around items-center text-white font-bronson uppercase text-5xl font-extrabold m-auto text-center"
            >
                ORGANIZERS
            </div>
